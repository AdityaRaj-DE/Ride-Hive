    ...
    <div className="min-h-screen text-primary pb-24">
      <div className="max-w-5xl mx-auto px-6 pt-16 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <Link 
            to="/profile/edit"
            className="h-14 px-8 rounded-xl bg-surface border border-border flex items-center justify-center gap-3 text-primary hover:bg-background transition-all active:scale-95 shadow-sm group"
          >
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-card p-6 sm:p-10 border-accent/10 shadow-xl relative overflow-hidden text-center">
              ...
              <div className="flex items-center justify-center gap-2 text-accent mb-8 bg-accent/5 py-3 rounded-2xl border border-accent/10 mx-4">
                 ...
                 <span className="text-xs font-bold ml-1 text-primary">5.0 Rating</span>
              </div>
            ...
            <div className="glass-card p-6 border-accent/10 bg-accent/5 flex flex-col gap-4 text-center sm:text-left">
               <div className="flex items-center justify-center sm:justify-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-accent">
                     <Award className="w-5 h-5" />
                  </div>
                  <div>
                     <p className="text-[10px] font-bold uppercase tracking-widest text-accent">Elite Status</p>
                     <p className="text-xs font-semibold text-primary uppercase">Loyalty Member</p>
                  </div>
               </div>
               <p className="text-xs font-medium text-secondary leading-relaxed opacity-60 italic">You qualify for priority booking and exclusive partner discounts.</p>
            </div>
          </div>

          {/* Details Section */}
          <div className="lg:col-span-8 space-y-8">
            <section className="glass-card p-10 border-accent/10 shadow-xl relative overflow-hidden">
               <div className="absolute top-0 right-0 p-10 opacity-[0.02] pointer-events-none rotate-12">
                  <User className="w-48 h-48 text-accent" />
               </div>
               
               <h3 className="text-xl font-bold tracking-tight text-primary uppercase mb-10 flex items-center gap-3">
            ...
            <section className="glass-card p-10 border-accent/10 shadow-xl relative overflow-hidden">
               ...
               <div className="flex flex-col sm:flex-row items-center justify-between p-6 sm:p-8 rounded-2xl bg-accent/5 border border-accent/10 gap-6 sm:gap-8">
                  ...
                  <Link 
                    to="/history"
                    className="w-full sm:w-auto h-14 px-8 rounded-xl bg-accent text-white font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-accent/20"
                  >
            ...
            <div className="flex flex-col sm:flex-row gap-6">
               <button 
                 className="h-14 flex-1 rounded-xl bg-rose-500/5 border border-rose-500/10 text-rose-500 font-bold uppercase tracking-widest text-[10px] hover:bg-rose-500 hover:text-white transition-all flex items-center justify-center gap-3 active:scale-95 group"
               >
      ...
      <footer className="mt-24 pt-12 border-t border-border opacity-20 flex flex-col items-center gap-4">
         <p className="text-[9px] font-bold uppercase tracking-widest text-muted">Hive Mobility • Secure Profile Node</p>
      </footer>
    </div>
  );
};
